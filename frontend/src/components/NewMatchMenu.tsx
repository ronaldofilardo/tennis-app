...
// Menu de opções ao criar ou encontrar partidas (Refatorado com DetailsPanel pattern).
...
const NewMatchMenu: React.FC<NewMatchMenuProps> = ({
  ...
  return (
    <div ref={menuRef} className="new-match-menu">
      <DetailsPanel accentColor="default" className="new-match-menu__panel">
        {/* Opção 1: Criar Nova Partida */}
        <button
          role="menuitem"
