      ...
      <div className="gestor-content">
          ...
          <div className="gestor-overview">
            ...
            <div className="gestor-kpi-grid">
              ...
              <div className="kpi-card">
                ...
                <div className="kpi-value">
                  {stats.matchesByStatus.find((m) => m.status === "IN_PROGRESS")
                    ?.count || 0}
                </div>
            ...
            <div className="gestor-section">
              ...
              {stats.recentMembers.length === 0 ? (
                ...
                <div className="gestor-member-list">
                  ...
                  <div className="gestor-section">
                    ...
                    {!subscription.canAddAthlete && (
                      <p className="gestor-warning">
                        Limite de atletas atingido. Faça upgrade para adicionar
                        mais.
                      </p>
                    )}
                  </div>
        ...
        {activeTab === "settings" && (
          <div className="gestor-settings-tab">
            ...
            <div className="gestor-section">
              <h4>Identidade Visual (White-Label)</h4>
              <p className="gestor-muted">
                Personalize cores, logo e nome do aplicativo para seu clube.
              </p>
              <PlanGate requiredFeature="custom_branding">
                <button
                  className="gestor-btn-primary"
                  onClick={() => navigation.replace("/club-settings")}
                >
            ...
            <PlanGate requiredFeature="custom_domain" hideIfBlocked>
              <div className="gestor-section">
                <h4>Domínio Personalizado</h4>
                <p className="gestor-muted">
                  Configure um domínio próprio para seu clube (ex:
                  app.seuclube.com.br).
                </p>
                <p className="gestor-muted">
            ...
            <div className="gestor-section">
              ...
              <p className="gestor-muted">
                Configure termos de uso e política de privacidade do clube.
              </p>
              <button
                className="gestor-btn-secondary"
                onClick={() => navigation.replace("/club-settings")}
