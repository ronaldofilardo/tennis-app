...
describe('matchService', () => {
  ...
  describe('createMatch', () => {
    ...
    it('deve lançar erro para dados inválidos', async () => {
      ...
      matchService.createMatch.mockRejectedValue(new Error('Erro de validação'));
  ...
  describe('getMatchById', () => {
    ...
    it('deve lançar erro 404 para partida não encontrada', async () => {
      matchService.getMatchById.mockRejectedValue(new Error('Partida não encontrada'));
  ...
  describe('updateMatchState', () => {
    it('deve atualizar estado da partida com sucesso', async () => {
      ...
      const result = await matchService.updateMatchState('match-123', matchState);
    ...
    it('deve aceitar payload como string', async () => {
      ...
      const result = await matchService.updateMatchState('match-123', matchStateString);
    ...
    it('deve lidar com payload inválido', async () => {
      ...
      await expect(matchService.updateMatchState('match-123', 'INVALID_JSON')).rejects.toThrow(
        'Erro ao fazer parse do matchState',
      );
    });
