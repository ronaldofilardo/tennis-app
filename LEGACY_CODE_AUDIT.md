...
#### [frontend/src/__tests__/contracts.test.js](frontend/src/__tests__/contracts.test.js)
...
|---------|------|-------|----------|
| check_*.cjs (5 arquivos) | Debug | Inspecionar dados de DB | **Considerar remover** |
